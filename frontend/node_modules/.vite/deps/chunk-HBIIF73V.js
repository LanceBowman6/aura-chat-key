import {
  ...
  require_semver
} from "./chunk-LIRZQDPO.js";
import {
  RpcSchema_exports,
  call_exports,
  mini_exports
} from "./chunk-OS2U6JVT.js";
import {
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/baseAccount.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-WBSLPQ4O.js");
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/coinbaseWallet.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-OJX2OYKU.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-SDPE3K3G.js");
...
// node_modules/.pnpm/@gemini-wallet+core@0.3.2_viem@2.38.6_bufferutil@4.0.9_typescript@5.9.3_utf-8-validate@5.0.10_zod@3.25.76_/node_modules/@gemini-wallet/core/dist/index.js
var package_default = {
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/gemini.js
gemini.type = "gemini";
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/metaMask.js
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-WKJB7Y65.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// node_modules/.pnpm/porto@0.2.35_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_@wagmi+cor_26ed047f4d6cc1e179601308f8da193e/node_modules/porto/dist/trusted-hosts.js
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/porto.js
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-BFSNWOUO.js");
          return Porto.create({
            ...parameters,
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/safe.js
safe.type = "safe";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-H3XSPOC5.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-BQ7IVPR7.js");
...
// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/version.js
var version = "6.1.4";

// node_modules/.pnpm/@wagmi+connectors@6.1.4_@tanstack+react-query@5.90.7_react@18.3.1__@types+react@18.3.26_d2d05f5a0b5e96eca28803ddf5939732/node_modules/@wagmi/connectors/dist/esm/walletConnect.js
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-VAQM6FPC.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HBIIF73V.js.map

...
import "./tasks/EncryptedChat";
import "./tasks/BidVault";
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      url: SEPOLIA_RPC_URL,
      timeout: 300000, // Increased timeout to handle network issues (error 522)
      httpHeaders: {},
    },
  },
  paths: {
  ...
  solidity: {
    ...
    settings: {
      ...
      // Use the Yul-based IR pipeline to avoid "stack too deep" issues
      viaIR: true,
      evmVersion: "cancun",
    },
  },
